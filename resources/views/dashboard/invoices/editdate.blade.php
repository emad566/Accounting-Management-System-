...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">تعديل تاريخ فاتورة رقم: <a href="{{ route('invoices.show', [$invoice->id]) }}"><span class="badge badge-pill badge-cyan ml-auto">{{ $invoice->invoice_code }}</span></a> </h4>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    @php $cols = 3; @endphp
                    @include('dashboard.invoices.editdateModel')
                </div>
            </div>
        </div>
    </div>
