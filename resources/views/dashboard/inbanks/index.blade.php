...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-12 align-self-center">
            <h4 class="text-themecolor">كل الإيداعات المالية الخارجية</h4>
        </div>
        <div class="col-md-12 align-self-center text-right" dir="rtl">
            <div class="d-flex justify-content-end align-items-center">
                    ...
                    <div class="modal-dialog modal-dialog-centered  modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="vcenter">إضافة إيداع مالي خارجي</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <div class="modal-body text-left">
                                @php $cols = 12; @endphp
                                @include('dashboard.inbanks.createModel')
                            </div>
                ...
                <a href="{{ route('inbanks.create') }}" data-toggle="modal" data-target="#verticalcenter" class="btn btn-info  m-l-15"><i class="fa fa-plus-circle"></i> {{ trans('main.Add New') }}</a>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">كل الإيداعات المالية الخارجية</h4>

                    <form id='delete-formMulti' class='delete-formMulti'
                        method='post'
                        action='{{ route('inbanks.delete') }}'>
                        @csrf
                        ...
                        @php
                            $fields = [
                                // ['id', 'transAttr'=>true],
                                // ['inbank_code', 'transAttr'=>true],
                                ['to_bank->bank_name', 'transval'=>'إلي'],
                                ['inbank_amount', 'transval'=>'المبلغ'],
                                ['status->name', 'transval'=>'الحالة'],
                                ['inbank_date', 'transAttr'=>true],
                            ];
                        @endphp
            ...
            $(function() {
                var table = $('.datatable').DataTable({
                    ...
                    "columnDefs": [
                        ...
                        { "className": 'all', "targets": [2,6] },       //Show on all devices
                    ],
