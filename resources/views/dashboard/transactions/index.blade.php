...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-12 align-self-center">
            <h4 class="text-themecolor">إيداعات المندوبين</h4>
        </div>
        <div class="col-md-12 align-self-center text-right" dir="rtl">
            <div class="d-flex justify-content-end align-items-center">
                    ...
                    <div class="modal-dialog modal-dialog-centered  modal-xl">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="vcenter">إنشئ تحويل مالي</h4>
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            </div>
                            <div class="modal-body text-left">
                                @php $cols = 12; @endphp
                                @include('dashboard.transactions.createModel')
                            </div>
                ...
                <a href="{{ route('transactions.create') }}" data-toggle="modal" data-target="#verticalcenter" class="btn btn-info  m-l-15"><i class="fa fa-plus-circle"></i> {{ trans('main.Add New') }}</a>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">إيداعات المندوبين</h4>
                    ...
                    <form id='delete-formMulti' class='delete-formMulti'
                        method='post'
                        action='{{ route('transactions.delete') }}'>
                        @csrf
                        ...
                        @php
                            $fields = [
                                // ['id', 'transAttr'=>true],
                                ['transaction_code', 'transAttr'=>true],
                                ['from_user->name', 'transval'=>'من'],
                                ['bank->bank_name', 'transval'=>'الحساب'],
                                ['amount', 'transval'=>'المبلغ'],
                                ['status->name', 'transval'=>'الحالة'],
                                ['transaction_date', 'transAttr'=>true],
                            ];
                        @endphp
            ...
            $(function() {
                var table = $('.datatable').DataTable({
                    ...
                    "columnDefs": [
                        ...
                        { "className": 'all', "targets": [2,6,8] },       //Show on all devices
                    ],
