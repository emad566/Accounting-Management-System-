...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">تعديل تحويل مالي</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <a href="{{ route('transactions.index') }}" class="btn btn-primary float-right mx-2">إيداعات المندوبين</a>
                <a href="{{ route('transactions.show', $transaction->id) }}" class="btn btn-primary float-right">عرض</a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h6>تعديل تحويل مالي</h6>
                    <hr>
                    @php $cols = 3; @endphp
                    @include('dashboard.transactions.editModel')
                </div>
            </div>
        </div>
    </div>
