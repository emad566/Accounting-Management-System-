    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">جرد المخازن SQL</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title row"></h6>
                        <?php $store_id = $store ? $store->id : null; ?>
                        @include('dashboard.storestocks.selectview')

                        <?php $start = microtime(true); ?>
                        @if ($store && $store->viewStockClosedSql)
                            @php
                                $products = $store->viewStockClosedSql
                                    ->where('is_store_q', '<>', 0)
                                    ->sortBy(function ($q) {
                            ...
                            <div class="table-responsive m-t-40 w-100">
                                {!! indexTable([
                                    'objs' => $products,
                                    'table' => 'stores',
                                    'title' => 'Store_Name',
