...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">كميات الأصناف بالمخازن</h6>
            ...
            $(function() {
                ...
                var table = $('#yajraTable').DataTable({
                    ...
                    drawCallback:function(settings, row, data, start, end, display){
                        ...
                        $('#voucher_q_outs').html(settings.json.voucher_q_outs)
                    },
                    ...
                    "columns":[
                        ...
                        { data: 'voucher_q_out', name: 'voucher_q_out'}
                    ],
